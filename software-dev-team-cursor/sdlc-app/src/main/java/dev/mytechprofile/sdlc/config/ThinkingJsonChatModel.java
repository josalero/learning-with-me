 ...
 *
 * <p><strong>When to use:</strong> wrap Cursor CLI chat models. Reasoning models often return
 ...
 *
 * <p><strong>Example:</strong> {@code new ThinkingJsonChatModel(cursorCli, fallback).chat(request)}
...
public final class ThinkingJsonChatModel implements ChatModel {
     ...
     *
     * @param delegate Cursor CLI or test chat model
     */
