 ...
 * without the Cursor CLI. It does <em>not</em> implement the demo feature in the seed repo.
 *
...
public final class ScriptedChatModel implements ChatModel {
    ...
    private static final String CHANGE_SUMMARY =
            ...
            {
              "filesTouched": [],
              "rationale": "Offline demo model does not edit the seed. Run with CURSOR_API_KEY to implement.",
