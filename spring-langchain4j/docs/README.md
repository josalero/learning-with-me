...
| [../langchain4j-app/docs/architecture.md](../langchain4j-app/docs/architecture.md) | LangChain4j agentic app internals |

Shared build inputs (not under `docs/`):

| Path | Purpose |
|---|---|
| [`../shared-fixtures/`](../shared-fixtures/) | JSON contract fixture used by both apps' tests |
| [`../shared-prompts/`](../shared-prompts/) | Identical system prompts packaged into both apps |
